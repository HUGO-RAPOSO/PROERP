    ...
    return (
        <div className="min-h-screen bg-white p-8 space-y-8" id="grade-report-container">
            ...
            <div className="flex justify-end no-print">
                <button
                    onClick={() => {
                        // Client-side print trigger usually needs 'use client', but we can use inline js or a client component wrapper.
                        // For simplicity in server component, we can use a small script or just let user use browser print.
                        // Better: Use a simple script tag or link.
                    }}
                    // Note: Since this is a server component, we can't add onClick handlers directly that assume browser context without 'use client'.
                    // However, we can just instruct user to Print or use the browser menu. 
                    // Let's add a small script for auto-print prompt if needed, or better, make this a Client Component if interaction is heavy.
                    // For now, let's keep it simple CSS-based.
